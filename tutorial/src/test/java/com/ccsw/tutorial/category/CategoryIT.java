...
//
//        ResponseEntity<CategoryDto> response = restTemplate.exchange(LOCALHOST + port + SERVICE_PATH + "/1",
//                HttpMethod.GET, null, CategoryDto.class); // category/1 no implementado en controller
//
//        assertNotNull(response);
...
//    }
    ...
    public void modifyWithNotExistIdShouldInternalError() {
        ...
        ResponseEntity<Void> response = restTemplate.exchange(LOCALHOST + port + SERVICE_PATH + "/" + NEW_CATEGORY_ID,
