...
import com.ccsw.tutorial.common.pagination.WrapperPageableRequest;
...
public class AuthorIT {
    ...
    public void findFirstPageWithFiveSizeShouldReturnFirstFiveResults() {
        ...
        WrapperPageableRequest searchDto = new WrapperPageableRequest();
        searchDto.setPageableRequest(new PageableRequest(0, PAGE_SIZE));
    ...
    public void findSecondPageWithFiveSizeShouldReturnLastResult() {
        ...
        WrapperPageableRequest searchDto = new WrapperPageableRequest();
        searchDto.setPageableRequest(new PageableRequest(1, PAGE_SIZE));
    ...
    public void saveWithoutIdShouldCreateNewAuthor() {
        ...
        WrapperPageableRequest searchDto = new WrapperPageableRequest();
        searchDto.setPageableRequest(new PageableRequest(0, (int) newAuthorSize));
    ...
    public void deleteWithExistsIdShouldDeleteCategory() {
        ...
        WrapperPageableRequest searchDto = new WrapperPageableRequest();
        searchDto.setPageableRequest(new PageableRequest(0, TOTAL_AUTHORS));
